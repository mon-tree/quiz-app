...
public class QuestionFacade {
    public static List<Question> getQuestion(QuestionQueryBuilder query) throws SQLException{
        Configs.questionService.setQuery(query);
        return Configs.questionService.list();
    }
    
    public static List<Question> getLazyQuestion(QuestionQueryBuilder query) throws SQLException{
        Configs.questionService.setQuery(query);
